...
//             res.sendStatus(500);
//         } else {
//             client.query(`UPDATE company SET status = 'complete' WHERE id = $1;`, [jobIdToComplete], function(errorMakingQuery, result){
//                 done();
//                 if (errorMakingQuery) {
//                     console.log('error making query', errorMakingQuery);
//                     res.send(500);
...
//             res.sendStatus(500);
//         } else {
//             client.query(`DELETE FROM company WHERE id=$1;`, [jobIdToRemove], function(errorMakingQuery, result){
//                 done();
//                 if (errorMakingQuery) {
//                     console.log('error making query', errorMakingQuery);
//                     res.send(500);
